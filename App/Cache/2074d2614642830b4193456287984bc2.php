							...
							<!--content s-->
								<div class="story_content" style="border-bottom:1px solid #ECECEC;"> 
								  <div class="story_content_detail">
								  	<div class="storyleftimg" style="width:150px;height:190px;"><img src="/Attachments/article/<?php echo (is_array($vo)?$vo["attachpath"]:$vo->attachpath); ?>/<?php echo (is_array($vo)?$vo["attachment"]:$vo->attachment); ?>" /></div>
									<div class="storyline"></div>
									<div class="storyrightcontent">
										<div class="peopletitle">
											<p><?php echo (is_array($vo)?$vo["subject"]:$vo->subject); ?></p> 
										</div>
										<div class="story_people_content" style="float:none; width:450px;">
											<br/> 
