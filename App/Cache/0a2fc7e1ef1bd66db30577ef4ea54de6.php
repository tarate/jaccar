				...
				<!--main s-->
					...
					<!--second menu s-->
					 ...
					 <!--second menu e-->
						 ...
						 <!--right s-->
						 	<div class="right">
							<div class="strategy_title"><img src="/App/Tpl/default/Public/images/director_title.jpg" /></div>
							<!--content s-->
								<div class="story_content" style="border-bottom:1px solid #ECECEC;"> 
								  <div class="story_content_detail">
								  	<div class="storyleftimg"><img src="/App/Tpl/default/Public/images/director_05_img.jpg" /></div>
									<div class="storyline"></div>
									<div class="storyrightcontent">
										<div class="peopletitle">
											<p>RAMON DE OLIVEIRA</p>
											<p>Born September 9, 1954</p>
											<p>French and Argentinian Nationality</p>
										</div>
										<div class="story_people_content" style="float:none; width:390px;">
											<br/><p>Mr. Ramon de Oliveira is a graduate of the University of Paris and of the Institut d’Etudes Politiques, Paris. In 1977, he joined JP Morgan in Paris. After two years in New York, he spent 10 years in London in a number of investment banks as well as on sales and trading assignments. Upon the merger with Chase, he was the sole executive from JP Morgan & Co. sought to join the Executive Committee of the new firm with operating responsibilities. Between 2002 and 2006, he was an Adjunct Professor of Finance at Columbia University. Mr. Ramon de Oliveira is now Managing Partner of the consulting firm Investment Audit Practice LLC and has been a JACCAR Board Member since 2011.</p><br/>
											<p style="font-weight:bold; font-size:12px; font-style:italic; color:#333;">CURRENT DIRECTORSHIPS </p>
											<p>• JACCAR, Board Member</p>
											<p>• Investment Audit Practice LLC, Managing Director</p>
											<p>• Kauffman Foundation, Trustee and Chairman of the Investment Committee</p>
											<p>Director:</p>
											<p>• Taittinger-Kobrandt</p>
											<p>• AXA</p>
											<p>• Quilvest</p>
											<br/>
											<p style="font-weight:bold; font-size:12px; font-style:italic; color:#333;">FORMER DIRECTORSHIPS (Last 5 Years)</p>
											<p>Director:</p>
											<p>• JP Morgan Suisse</p>
											<p>• American Century Company, Inc.</p>
											<p>• Sungard Data System</p>
											<p>• The Hartford Insurance Company</p>
										</div>
									</div>
								  </div>
								</div>
							<!--content e-->
							<div class="storygoback" onclick="javascript:history.go(-1);">Back to list</div>
							</div>
