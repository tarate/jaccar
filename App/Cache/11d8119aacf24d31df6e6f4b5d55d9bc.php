					...
					<!--second menu s-->
					 ...
					 <!--second menu e-->
						 ...
						 <!--right s-->
						 	<div class="right">
							<!--content s-->
							    <div class="strategy_title"><img src="/App/Tpl/default/Public/images/press_release_title.jpg" /><a href="/index.php?s=/Article/rss.html" target="_blank"><img src="/App/Tpl/default/Public/images/rss.gif" /></a></div>
								<div class="lastest_news_content">  
								  <?php if(is_array($list)): ?><?php $i = 0;?><?php $__LIST__ = $list?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = (($i % 2 )==0)?><!--onecase s-->
									<div class="newslist">
											...
											<div class="detailbtn"><a href="/index.php?s=/Article/press_release_detail/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>.html"><img src="/App/Tpl/default/Public/images/news_detail_btn.png" /></a></div>
										</div>
									<!--onecase e-->
