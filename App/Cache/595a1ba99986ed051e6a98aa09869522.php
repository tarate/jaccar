				...
				<!--main s-->
					...
					<!--second menu s-->
					 ...
					 <!--second menu e-->
						 ...
						 <!--right s-->
						 	<div class="right">
						 	    <?php if($username != ''): ?><div class="jaccar_top_btn"><a href="/index.php?s=/Public/upload.html"><img src="/App/Tpl/default/Public/images/presskit_btn2.png" /></a></div><?php endif; ?>
							<!--content s-->
							    <div class="strategy_title"><img src="/App/Tpl/default/Public/images/presskit_logo.jpg" /></div>
								<div class="presskit_content"> 
								   <?php if(is_array($list)): ?><?php $i = 0;?><?php $__LIST__ = $list?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = (($i % 2 )==0)?><div class="onetitle">
											<div class="lefttext"><?php echo (is_array($vo)?$vo["title"]:$vo->title); ?></div>
											<div class="rightbtn"><a href="/App/Tpl/default/Public/flash/<?php echo (is_array($vo)?$vo["filename"]:$vo->filename); ?>" onclick="presskit(this);"><img src="/App/Tpl/default/Public/images/presskit_btn.png" /></a></div>
											<?php if($username != ''): ?><div class="rightbtn2"><a href="/index.php/Public/DelPressKit/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>" onclick="return confirm('Confirm Delete?');"><img src="/App/Tpl/default/Public/images/delete.png" /></a></div><?php endif; ?>
