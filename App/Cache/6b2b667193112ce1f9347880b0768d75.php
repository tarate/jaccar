				...
				<!--main s-->
					...
					<!--second menu s-->
					 ...
					 <!--second menu e-->
						 ...
						 <!--right s-->
						 	<div class="right">
								<div class="jaccar_top_btn"><a href="press_release.html"><img src="/App/Tpl/default/Public/images/jaccar_news_top.jpg" /></a></div>
							<!--content s-->
							    <div class="strategy_title"><img src="/App/Tpl/default/Public/images/jaccar_news_title.jpg" /></div>
									<!-- search year s-->
									<div id="search_year_control2">
										<div id="search_year_select2">
											<ul> 
												<li lang="/index.php?s=/Article/jaccar_news2/year/2012.html">2012</li> 
<li lang="/index.php?s=/Article/jaccar_news2/year/2011.html">2011</li>
<li lang="/index.php?s=/Article/jaccar_news2/year/2010.html">2010</li>
<li lang="/index.php?s=/Article/jaccar_news2/year/2009.html">2009</li>
<li lang="/index.php?s=/Article/jaccar_news2/year/2008.html">2008</li>
<li lang="/index.php?s=/Article/jaccar_news2/year/2007.html">2007</li>
											</ul> 
										</div> 
									</div>
								<!-- search year e-->  
								...
								<div class="datelist">
									<ul>
									 	<li class="selectdateli" onclick="SelectBox.changeSelectBox('search_year_select2');"> 
										<span id="search_year_select2_label" >2008</span>&nbsp;&nbsp;<img src="/App/Tpl/default/Public/images/date_drop.jpg" /> 
										</li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/01.html" id="month_01">JAN</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/02.html" id="month_02">FEB</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/03.html" id="month_03">MAR</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/04.html" id="month_04">APR</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/05.html" id="month_05">MAY</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/06.html" id="month_06">JUN</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/07.html" id="month_07">JUL</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/08.html" id="month_08">AUG</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/09.html" id="month_09">SEP</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/10.html" id="month_10">OCT</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/11.html" id="month_11">NOV</a></li>
										<li><a href="/index.php?s=/Article/jaccar_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/12.html" id="month_12">DEC</a></li>
									</ul>
								</div>
								<div class="lastest_news_content" style="margin-top:0px;">  
									...
									<div class="newslist">
											...
											<div class="detailbtn"><a href="/index.php?s=/Article/jaccar_news_detail/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>.html"><img src="/App/Tpl/default/Public/images/news_detail_btn.png" /></a></div>
										</div>
									<!--onecase e-->
  ...
  <script>
	...
	SelectBox.autoSelect(document,"search_year_select2","selectoption"); 
		//$("#datecontrol").datepicker(); 
	//jQuery("#search_date_select_label").datepicker();
	jQuery("#search_year_select2_label").html("<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>")
	jQuery("#month_<?php echo (is_array($_REQUEST)?$_REQUEST["month"]:$_REQUEST->month); ?>").css("font-weight","bold");
	jQuery("#month_<?php echo (is_array($_REQUEST)?$_REQUEST["month"]:$_REQUEST->month); ?>").css("color","#000");
  </script>
 </div>
					<div class="clearboth"></div>
				<!--main e-->
