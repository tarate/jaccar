...
<div class="bodyTitle" style="margin-bottom:20px;">
  ...
  <div class="bodyTitleText">add stories</div>
</div>
<br> 
		
        
          <table width="100%" border="0" cellpadding="3" cellspacing="0"><form method="post" name="form1" action="/admin.php/Article/adds8" enctype="multipart/form-data">
