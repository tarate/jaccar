							...
							<!--content s--> 
								<div class="news_content_detail">  
									 ...
									 <div class="news_right">
										 <div class="news_date"><?php echo (date("d/m/Y",is_array($vo)?$vo["postdate"]:$vo->postdate)); ?></div>
									 ...
									 <div class="go_back">
										...
										<span class="goindex"><a href="<?php echo (is_array($vo)?$vo["link"]:$vo->link); ?>" target="_blank"><?php echo (is_array($category)?$category["title"]:$category->title); ?> Website</a></span>
										<span class="spec">|</span>
										<span class="gonewslist"><a href="/index.php?s=/Article/affiliates_news2/cid/<?php echo (is_array($category)?$category["id"]:$category->id); ?>.html"><?php echo (is_array($category)?$category["title"]:$category->title); ?> News List</a></span>									 </div>
								</div>
							<!--content e-->   
