...
<div class="bodyTitle"  style="margin-bottom:20px;">
  ...
  <div class="bodyTitleText">update points</div>
</div>
<br><h3 class="marginbot"></h3>
		
        
          <table width="100%" border="0" cellpadding="3" cellspacing="0"><form method="post" name="form1" action="/admin.php/Article/edits7" enctype="multipart/form-data">
            <tr>
