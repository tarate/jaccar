...
<body> 
					...
					<!--second menu s-->
					 ...
					 <!--second menu e-->
						 ...
						 <!--right s-->
						 	<div class="right">
							<!--content s-->
							    <div class="strategy_title"><img src="/App/Tpl/default/Public/images/key_title.jpg" /></div>
								<div class="strategy_content" >
								    <div class="scroll_key_content" >
										<img src="/App/Tpl/default/Public/images/tark2.png" width="600" height="1022"    />
										<!--<div style="margin-top:10px;"><img src="/App/Tpl/default/Public/images/tark2.png" width="600" height="1200" vspace="9"/></div>-->
									</div>
								</div>
  ...
  <script>
   var oldshow = null;
	...
	<script> 
		jQuery(".scroll_key_content").setScroll( 
