					...
					<!--second menu s-->
					 ...
					 <!--second menu e-->
						 ...
						 <!--right s-->
						 	<div class="right">
							<!--content s-->
							    <div class="strategy_title"><img src="/App/Tpl/default/Public/images/lastest_news_title.jpg" /></div>
								<!-- search year s-->
...
<li lang="/index.php?s=/Article/lastest_news2/year/2007.html">2007</li>
								...
								<div class="datelist">
									<ul>
										...
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/01.html" id="month_01">JAN</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/02.html" id="month_02">FEB</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/03.html" id="month_03">MAR</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/04.html" id="month_04">APR</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/05.html" id="month_05">MAY</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/06.html" id="month_06">JUN</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/07.html" id="month_07">JUL</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/08.html" id="month_08">AUG</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/09.html" id="month_09">SEP</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/10.html" id="month_10">OCT</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/11.html" id="month_11">NOV</a></li>
										<li><a href="/index.php?s=/Article/lastest_news2/year/<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>/month/12.html" id="month_12">DEC</a></li>
									</ul>
								</div>
								<div class="lastest_news_content" style="margin-top:0px;">  
								 	 <?php if(is_array($list)): ?><?php $i = 0;?><?php $__LIST__ = $list?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = (($i % 2 )==0)?><!--onecase s-->
										<div class="newslist">
												...
												<div class="detailbtn"><a href="/index.php?s=/Article/news_detail/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>/cid/<?php echo (is_array($vo)?$vo["cid"]:$vo->cid); ?>.html"><img src="/App/Tpl/default/Public/images/news_detail_btn.png" /></a></div>
											</div>
										<!--onecase e-->
							...
							<!--pager e-->  
							<div class="clearboth"></div>
							<!-- search company control s-->
								<div id="search_company_control" style=" bottom:22px;">
										<div id="search_company_select">
										<ul>
									...
									<div  id="search_company_select_label" onclick="SelectBox.changeSelectBox('search_company_select');">Search by Company</div>
								</div>
							<!-- search company control e-->
  ...
  <script>
	...
	$("#search_year_select2_label").html("<?php echo (is_array($_REQUEST)?$_REQUEST["year"]:$_REQUEST->year); ?>")
